...
2) run this program:
./RunLoop.py -t 2011-03-01T00:00Z -E ~/data/100MeVtop.h5 -c 65 -147.5 --f107 115 \
      --f107p 115 --f107a 96 --ap 7 -o ~/data/rates.h5
...
# %% plotting
    if p.eigenprof:
        ...
        optsim = namedtuple('sim', ['reacreq', 'opticalfilter'])
