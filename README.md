...
-------------
```
f2py3 --opt='-fno-align-commons' -m aurora -c machprec.f90 glow.f vquart.f90 gchem.f ephoto.f solzen.f rcolum.f etrans.f exsect.f ssflux.f snoem.f90 snoemint.f geomag.f nrlmsise00.f qback.f fieldm.f iri90.f aurora_sub.f
```
