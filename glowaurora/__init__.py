...
#
from sciencedates import find_nearest, datetime2yeardoy
try:
...
# %% production and loss rates
    prate = prate.T
    lrate = lrate.T  # fortran to C ordering 2x170x20, only first 12 columns are used
...
# %% flux grid / date
    ...
    yd, utsec = datetime2yeardoy(t0)[:2]
# %% (0) define altitude grid [km]
    # z = glowalt()
