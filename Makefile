...
#
SOURCES = machprec.f90 egrid.f90 ephoto.f maxt.f90 etrans.f exsect.f fieldm.f vquart.f90 gchem.f geomag.f glow.f iri90.f nrlmsise00.f qback.f rcolum.f rout.f snoem.f90 snoemint.f solzen.f ssflux.f aurexample.f 
